...
/**
 * JUnit 5 Test Runner for Complete Notice Reports Flow Only
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@GenerateCompleteNoticeReports")
...
public class CompleteNoticeReportsTestRunner {
