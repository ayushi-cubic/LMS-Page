...
/**
 * JUnit 5 Test Runner for Contact Management Tests
 * 
 * This runner executes all Contact Management feature scenarios
 * Run with: mvn test -Dtest=ContactTestRunner
 */
@Suite
...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@ContactManagement")
