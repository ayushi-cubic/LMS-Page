...
/**
 * Page Object Model for Customer Asset Bulk Upload Page
 */
public class CustomerAssetBulkUploadPage {
    ...
    // Customer Asset Bulk Upload Page Locators
    ...
    // Constructor
    public CustomerAssetBulkUploadPage(WebDriver driver) {
        this.driver = driver;
    ...
    public void navigateToUploadPage() {
        try {
            System.out.println("Navigating to Upload page for Customer Assets...");
    ...
    /**
     * Select Customer Type - Customer Securities (value="5")
     */
    public void selectCustomerTypeSecurities() {
        try {
            System.out.println("Selecting Customer Type: Customer Securities...");
            ...
            // Select by value "5" which corresponds to Customer Securities
            customerTypeSelect.selectByValue("5");
            System.out.println("Selected Customer Type: Customer Securities (value=5)");
            ...
            throw new RuntimeException("Failed to select Customer Type - Customer Securities", e);
        }
    }
    ...
    /**
     * Fill Excel file with Customer Asset test data
     * @return path to the updated Excel file
     */
    public String fillExcelWithCustomerAssetData() {
        try {
            ...
            // Generate test data for Customer Asset
            Map<String, String> testData = generateCustomerAssetTestData();
            
            System.out.println("Filling Excel with Customer Asset data (Row 2)...");
     ...
     */
    private Map<String, String> generateCustomerAssetTestData() {
    ...
    /**
     * Perform complete customer asset bulk upload workflow
     */
    public void performCustomerAssetBulkUploadWorkflow() {
        navigateToUploadPage();
        selectUploadTypeCustomers();
        selectCustomerTypeSecurities();
        clickDownloadExcelFormat();
        waitForFileDownload(30);
        String filePath = fillExcelWithCustomerAssetData();
